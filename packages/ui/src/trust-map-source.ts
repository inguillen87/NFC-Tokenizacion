...
const DEFAULT_PUBLIC_RASTER_TEMPLATE = "https://a.basemaps.cartocdn.com/rastertiles/voyager_nolabels/{z}/{x}/{y}.png";
...
export function resolveTrustMapSource(overrides: TrustMapSourceOverrides = {}): TrustMapSourceConfig {
  ...
  const rasterTileTemplate = overrides.rasterTileTemplate
  ...
  const detail = overrides.detail
    || (mode === "pmtiles-ready"
      ...
      : mode === "self-hosted-raster"
        ...
        : "Fallback publico sin API key para demos; reemplazable por PMTiles o tiles propios.");
