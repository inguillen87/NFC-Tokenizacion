  ...
  return [
    {
      ...
      permissions: ["users:manage", "tenants:write", "batches:write", "analytics:read", "events:read", "tokenization:read", "tokenization:write"],
    },
    {
      ...
      permissions: ["users:manage", "batches:write", "analytics:read", "events:read", "tokenization:read", "tokenization:write"],
    },
    {
      ...
      role: "reseller",
      fullName: "Reseller",
      permissions: ["batches:write", "analytics:read", "events:read", "tokenization:read"],
    },
    {
