...
test("global CSS prevents dashboard maps from covering account drawer", () => {
  ...
  assert.match(globalsSource, /\.nexid-account-dialog::backdrop\s*\{[\s\S]*rgba\(2, 6, 23, 0\.94\) !important/);
  ...
  assert.match(globalsSource, /\.nexid-account-backdrop\s*\{[\s\S]*rgba\(2, 6, 23, 0\.92\) !important/);
