...
test("admin BFF binds only the exact high-impact batch method and path pairs", () => {
  const exact = [
    ...
    ["GET", "consumer-network/overview", "crm:read"],
    ["GET", "consumer-network/products", "crm:read"],
    ["GET", "consumer-network/taps", "crm:read"],
    ["GET", "consumer-network/members", "consumers.read_pii"],
    ["GET", "campaigns/audience", "campaigns:read"],
    ["GET", "leads", "leads.manage"],
    ["POST", "leads", "leads.manage"],
    ["GET", "tickets", "leads.manage"],
    ["POST", "tickets", "leads.manage"],
