  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Scans (7d)" value="22.4k" delta="+12.4%" tone="good" />
        <StatCard label="Duplicate attempts" value="202" delta="-8.3%" tone="good" />
        <StatCard label="Tamper alerts" value="32" delta="+4 incidents" tone="warn" />
        <StatCard label="SLA / SUN verify" value="99.96%" delta="healthy" tone="good" />
      </div>

      <div className="grid gap-6 xl:grid-cols-2">
        <Card className="p-5">
          <h3 className="text-sm font-semibold text-white">Scans, duplicates and tamper trend</h3>
        ...
        <Card className="p-5">
          <h3 className="text-sm font-semibold text-white">Batch status distribution</h3>
          <div className="mt-4 h-72">
            <ResponsiveContainer width="100%" height="100%">
