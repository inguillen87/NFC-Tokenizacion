...
const DEFAULT_PERMISSIONS = ["users:manage", "batches:write", "events:read", "incidents:read", "incidents:write", "analytics:read", "tokenization:read", "tokenization:write", "tenants:write"];
