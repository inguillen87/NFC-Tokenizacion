...
export function getAccessProfiles(): AccessProfile[] {
  return [
    ...
    profile({
      ...
      permissions: ["batches:read", "batches:write", "tags:read", "tags:write", "events:read", "incidents:read", "incidents:write", "proof:read", "tokenization:read", "tokenization:write", "analytics:read", "rewards:validate", "demo:read", "demo:run"],
    }),
    profile({
      key: "tenant-growth",
