export const DASHBOARD_RELEASE='2026.09.23-dashboard.38';
export const DASHBOARD_RELEASE_DATE='2026-09-23';
export const RELEASE_NOTES={
'es-AR':{
 link:'Novedades y versión',eyebrow:'Seguimiento de soporte',title:'Cada cambio de estado tiene su historia.',
 summary:'Después de encontrar un ticket, podés consultar su historial y registrar un cambio de estado con un motivo. La confirmación muestra lo que quedó guardado. Cambiar el estado organiza el seguimiento interno; no envía una respuesta al cliente.',
...
'en':{
 link:'What is new and version',eyebrow:'Support follow-up',title:'Every status change has a history.',
 summary:'After finding a ticket, read its history and record a status change with a reason. Confirmation shows what was saved. A status change organizes internal follow-up; it does not send a reply to the customer.',
 back:'Open customer support',site:'nexID website',label:'Interface version',changes:'Changes',guide:'Workflow',
 steps:['In Customer support, open a ticket from its row or signal. You can also search its complete reference.','Open ticket management to read its current status and history.','Choose the new status, explain the reason and review the change before confirming.','If the case involves closing a recall, another authorized account must review and approve that closure.'],
...
'pt-BR':{
 link:'Novidades e versão',eyebrow:'Acompanhamento de suporte',title:'Cada mudança de estado tem sua história.',
 summary:'Depois de encontrar um chamado, consulte seu histórico e registre uma mudança de estado com um motivo. A confirmação mostra o que foi salvo. Mudar o estado organiza o acompanhamento interno; não envia uma resposta ao cliente.',
 back:'Abrir atendimento ao cliente',site:'Site da nexID',label:'Versão da interface',changes:'Mudanças',guide:'Fluxo de trabalho',
 steps:['Em Atendimento ao cliente, abra um chamado pela linha ou pelo sinal. Também pode buscar a referência completa.','Abra a gestão do chamado para consultar seu estado atual e histórico.','Escolha o novo estado, explique o motivo e revise a mudança antes de confirmar.','Se o caso envolver encerrar um recolhimento, outra conta autorizada deve revisar e aprovar esse encerramento.'],
