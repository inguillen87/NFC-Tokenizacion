    ...
    <main className="space-y-8">
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-4">
        <form className="grid gap-3 md:grid-cols-5">
          ...
          <input suppressHydrationWarning name="country" defaultValue={country} placeholder="country (AR, BR, US...)" className="rounded-xl border border-white/10 bg-slate-950 px-3 py-2 text-sm text-slate-200" />
          <button suppressHydrationWarning type="submit" className="rounded-xl border border-cyan-300/30 bg-cyan-500/10 px-3 py-2 text-sm font-medium text-cyan-100">Apply analytics scope</button>
        </form>
      </div>
