...
export default async function ApiKeysPage() {
  ...
  return (
    <main className="space-y-8">
      ...
      <DataTable title="API keys" columns={[{ key: "keyName", label: "Key" }, { key: "status", label: "Status" }, { key: "scope", label: "Scope" }, { key: "lastUsed", label: "Last used" }]} rows={rows} filterKey="status" loadingLabel={copy.shell.loading} emptyLabel={copy.shell.empty} />
    </main>
  );
}
