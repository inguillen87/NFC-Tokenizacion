...
export const platformVerticals: PlatformVertical[] = [
  ...
  },
  {
    id: "bottle",
    demoVertical: "bottle",
    title: "Botellas inteligentes & Refill",
    titleEn: "Smart Bottles & Refill",
    titlePt: "Garrafas inteligentes & Refill",
    shortTitle: "Botellas",
    ...
    imageLight: "/sdk/verticals/light/premium-bottle-light.webp",
    tags: ["GS1", "QR", "NFC"],
