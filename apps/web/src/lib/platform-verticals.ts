...
export const platformVerticals: PlatformVertical[] = [
  {
    ...
    shortTitle: "Agro",
    body: "Semillas, fitosanitarios, biológicos y alimentos con evidencia NFC, controles físicos configurables, uso responsable post-tap y datos de campo para CRM, ERP o Cropwise.",
    bodyEn: "Seeds, crop protection, biologicals and food with NFC evidence, configurable physical controls, responsible-use support and field data for CRM, ERP or Cropwise.",
    bodyPt: "Sementes, defensivos, biológicos e alimentos com evidência NFC, controles físicos configuráveis, suporte de uso responsável e dados de campo para CRM, ERP ou Cropwise.",
  ...
  },
  {
    ...
    shortTitle: "Eventos",
    body: "Pulseras, tickets, cashless, zonas VIP, consumos y capacidad en vivo con controles de replay o copia según el portador y la política configurada.",
    bodyEn: "Wristbands, tickets, cashless, VIP zones, consumption and live capacity with replay or copy controls subject to the carrier and configured policy.",
    bodyPt: "Pulseiras, ingressos, cashless, zonas VIP, consumos e capacidade ao vivo com controles de replay ou cópia conforme o portador e a política configurada.",
  ...
  },
  {
    ...
    shortTitle: "Salud",
    body: "Evidencia del mensaje NFC/QR, prospecto digital, lote declarado, recall por unidad y eventos de cadena de frio reportados.",
    bodyEn: "NFC/QR message evidence, digital leaflets, declared batches, unit recall and reported cold-chain events.",
    bodyPt: "Evidência da mensagem NFC/QR, bula digital, lote declarado, recall por unidade e eventos de cadeia fria reportados.",
  ...
  },
  {
    ...
    titlePt: "Luxo & Retail",
    shortTitle: "Lujo",
    body: "Identidad digital por unidad, garantía, reventa declarada, experiencias exclusivas y fidelización premium. La evidencia NFC/QR no certifica por sí sola la autenticidad física.",
    bodyEn: "Per-item digital identity, warranty, declared resale, exclusive experiences and premium loyalty. NFC/QR evidence does not by itself certify physical authenticity.",
    bodyPt: "Identidade digital por unidade, garantia, revenda declarada, experiências exclusivas e fidelização premium. A evidência NFC/QR não certifica, por si só, a autenticidade física.",
  ...
  },
  {
    ...
    shortTitle: "Calzado",
    body: "Drop conectado con evidencia del tag, control de reventa, registro de propiedad digital y beneficios de club. La validación del mensaje NFC no autentica por sí sola el calzado físico.",
    bodyEn: "Connected drop with tag evidence, resale controls, a digital ownership record and club benefits. NFC message validation does not by itself authenticate the physical footwear.",
    bodyPt: "Drop conectado com evidência do tag, controle de revenda, registro de propriedade digital e benefícios do clube. A validação da mensagem NFC não autentica, por si só, o calçado físico.",
  ...
  },
  {
    ...
    body: "Pallets, cajas, UHF/RFID, QR, NFC y sensores para eventos de ruta y temperatura reportados y auditables. Sin evidencia explícita, no prueba ruta física ni custodia.",
    bodyEn: "Pallets, cartons, UHF/RFID, QR, NFC and sensors for reported, auditable route and temperature events. Without explicit evidence, it does not prove the physical route or custody.",
    bodyPt: "Pallets, caixas, UHF/RFID, QR, NFC e sensores para eventos de rota e temperatura reportados e auditáveis. Sem evidência explícita, não comprova rota física nem custódia.",
