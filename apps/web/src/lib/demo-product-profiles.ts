...
export const DEMO_PRODUCT_PROFILES: Readonly<Record<DemoProductProfileKey, DemoProductProfile>> = {
  ...
  perfume: {
    ...
    lot: "EA-2047",
    vertical: "perfume",
    category: "Fragancia premium",
    origin: { city: "Buenos Aires", country: "AR", lat: -34.6037, lng: -58.3816 },
    sampleTap: { city: "Santiago", country: "CL", lat: -33.4489, lng: -70.6693 },
    images: [
      "/landing/connected-journey/perfume-journey-01.webp",
      "/landing/connected-journey/perfume-journey-02.webp",
      "/landing/connected-journey/perfume-journey-03.webp",
      "/landing/connected-journey/perfume-journey-03.webp",
    ],
  },
  agro: {
