...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      title: "Converti cada producto premium en una experiencia verificable de autenticidad, postventa y fidelizacion.",
      body: "El cliente toca NFC o QR, entiende si el producto es real, ve su historia, reclama garantia, entra al club de la marca y guarda un certificado digital propio.",
      primary: "Agendar demo",
      secondary: "Ver Demo Lab",
      tertiary: "Quiero ser reseller",
    },
    trustBar: ["Producto autentico", "Origen y lote", "Garantia digital", "Club y beneficios", "Marketplace white-label"],
    howItWorks: {
      eyebrow: "Como funciona",
      title: "Del producto fisico al vinculo directo con el cliente",
      description: "Cada toque responde tres preguntas simples: es real, de donde viene y que puede hacer ahora el comprador.",
      steps: [
        { title: "1. Cargas lote y fotos reales", body: "Producto, etiqueta, origen, reglas de claim y beneficios quedan listos antes de salir a gondola." },
        { title: "2. El cliente toca el producto", body: "La pantalla muestra una respuesta clara: autentico, origen visible y proxima accion." },
        { title: "3. Se crea evidencia comercial", body: "Quedan registrados tap, ciudad aproximada, estado del sello, canal y riesgo." },
        { title: "4. La marca activa postventa", body: "Garantia, club, puntos, experiencias verificadas, marketplace o NFT segun la estrategia." },
      ],
    },
    what: {
      eyebrow: "Que hace nexID",
      title: "Autenticidad, trazabilidad y relacion postventa desde un solo toque",
      description: "La marca protege cada unidad y el consumidor recibe una experiencia simple, confiable y accionable.",
      cards: [
        { title: "Producto autentico", body: "El usuario entiende en segundos si la unidad es real, si el sello esta correcto y si hay riesgo." },
        { title: "Historia visible", body: "Origen, lote, canal, taps y eventos se convierten en una historia facil de leer." },
        { title: "Cliente conectado", body: "Garantia, club, beneficios, experiencias verificadas, reventa y NFT opcional quedan dentro del portal." },
      ],
    },
    plans: {
      ...
      cards: [
        { name: "BASIC", badge: "QR / NTAG215", price: "Cotizacion por volumen", body: "Para campañas, eventos, garantias simples y medicion de escaneos.", bullets: ["Tap-to-web", "Datos por ciudad y canal", "Ideal para alto volumen"] },
        { name: "SECURE", badge: "NTAG 424 DNA TT", price: "Piloto + hardware codificado + SaaS", body: "Para marcas que necesitan autenticar, evitar copia y controlar apertura o uso.", bullets: ["Validacion dinamica", "Alertas por copia", "Sello fisico y trazabilidad"] },
        { name: "ENTERPRISE / RESELLER", badge: "White-label", price: "Custom", body: "Para operar varias marcas, paises, integraciones, marketplace y datos propios.", bullets: ["Marca propia", "API y webhooks", "Portal, dashboard y soporte"] },
      ],
    },
    secure: {
      eyebrow: "Cuando hay riesgo alto",
      title: "Capa secure para vino, cosmetica, lujo, eventos y documentos",
      description: "NTAG 424 DNA TagTamper ayuda a demostrar que el producto fisico estuvo presente y que el sello no fue manipulado.",
      bullets: ["Validacion dinamica por tap", "Senal de apertura para cierres y sellos", "Revocacion por lote", "Trazabilidad anti-replay"],
    },
    authenticity: {
      eyebrow: "Estados de autenticidad",
      title: "Lectura clara para consumidor, canal y equipo de riesgo",
      description: "La UX evita tecnicismos: muestra si el producto es real, si hay riesgo y cual es el proximo paso.",
      badges: { good: "VÁLIDO", warn: "OBSERVADO", risk: "BLOQUEADO" },
      cards: [
        { state: "Autentico", detail: "Lote activo, tap valido y origen coherente.", tone: "good" },
        { state: "Sello abierto", detail: "La apertura queda registrada para garantia, postventa o reclamo.", tone: "warn" },
    ...
    useCases: {
      ...
      cards: [
        { title: "Vinos y bebidas", body: "Botella autentica, origen, lote, apertura, club, reventa y certificado digital para exportacion." },
        { title: "Cosmetica y perfumes", body: "Producto real, sello en el punto de apertura, garantia, recompra y comunidad verificada." },
        { title: "Eventos y membresias", body: "Pulseras, entradas y accesos con tap fisico, beneficios y control de reventa." },
    ...
    intelligence: {
      ...
      description: "La ruta no es decoracion: muestra origen, taps, paises, riesgo, canal y oportunidades comerciales.",
      bullets: ["Mercados con mas demanda", "Alertas por geografia inesperada", "Analisis por lote, pais y tenant", "Vista ejecutiva para marcas y resellers"],
    },
    reseller: {
      eyebrow: "Canal",
      title: "Programa reseller para vender confianza en mas industrias",
      description: "Partners, agencias, distribuidores e integradores pueden ofrecer autenticidad, trazabilidad, postventa, clubes y marketplace sin reconstruir la tecnologia.",
      cards: [
        { title: "Propuesta lista para vender", body: "Bodega, cosmetica, eventos, agro, lujo o pharma pueden empezar con un piloto claro y demostrable." },
        { title: "Workspace white-label", body: "El partner opera con su marca, clientes, lotes, activos visuales y reglas comerciales." },
      ],
    },
    api: {
      eyebrow: "Arquitectura",
      title: "La complejidad queda atras; el usuario ve una respuesta simple",
      description: "nexID conecta producto, consumidor, marca y sistemas internos sin exponer criptografia, UID o integraciones al comprador final.",
      bullets: ["Autenticidad, estado y reglas por unidad", "Portal mobile para consumidor y club", "Eventos, alertas y mapas para el dashboard", "Integracion con CRM, e-commerce, ERP y webhooks"],
    },
    identity: {
    ...
    roi: { eyebrow: "ROI", title: "Valor defendible para direccion e inversores", description: "Menos fraude, mas datos propios y mas relacion postventa por cada unidad vendida.", metrics: [{ label: "Riesgo de fraude", value: "-30% a -70%", detail: "Depende de vertical, carrier y adopcion secure." }, { label: "Visibilidad comercial", value: "+10x", detail: "Mas datos por pais, ciudad, canal, lote y evento." }, { label: "Margen y fidelizacion", value: "+8% a +18%", detail: "Activado por club, garantia, marketplace y certificados." }] },
    ...
    cta: { title: "Listo para un piloto claro y vendible", body: "Elegimos una linea, lote o edicion premium; cargamos fotos reales, reglas de validacion, beneficios y dashboard; y probamos el flujo completo con usuarios reales.", primary: "Agendar demo", secondary: "Hablar con ventas" },
    docsList: ["Workshop comercial y tecnico", "Alta de tenant, roles y permisos", "Carga de lote, tags y banco visual", "Monitoreo, mapa, alertas y experiencias verificadas", "Go-live, metricas y plan de escala"],
  },
  "pt-BR": {
    nav: { product: "Produto", pricing: "Planos", reseller: "Revendedores", docs: "Arquitetura", cta: "Entrar", requestDemo: "Solicitar demo" },
    hero: { badge: "Autenticidade, rastreabilidade e pos-venda digital", title: "Transforme cada produto premium em um canal verificavel de confianca, garantia e fidelizacao.", body: "O cliente toca NFC ou QR, confirma se o produto e real, ve origem e lote, ativa garantia, recebe beneficios e guarda seu certificado digital.", primary: "Agendar demo", secondary: "Ver Demo Lab", tertiary: "Quero ser revendedor" },
