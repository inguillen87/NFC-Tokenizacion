...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      badge: "Identidad y evidencia para productos físicos",
      title: "Cada producto explica qué se sabe y qué hacer después.",
      body: "nexID conecta una etiqueta inteligente o un código con la información aprobada por tu organización. La persona consulta desde el navegador y ve un resultado claro, su fuente y el próximo paso.",
      primary: "Ver cómo funciona",
      secondary: "Diseñar un piloto",
      tertiary: "Conocer la plataforma",
    },
    ...
    cta: { title: "Empecemos con un producto y un objetivo concreto", body: "Diseñamos un piloto para una línea, lote o edición; definimos qué información mostrar, qué señales observar y qué acción habilitar después de cada consulta.", primary: "Diseñar un piloto", secondary: "Hablar con ventas" },
  ...
  "pt-BR": {
    ...
    hero: { badge: "Identidade e evidência para produtos físicos", title: "Cada produto explica o que se sabe e o que fazer depois.", body: "nexID conecta uma etiqueta inteligente ou um código à informação aprovada pela sua organização. A pessoa consulta pelo navegador e vê um resultado claro, sua fonte e o próximo passo.", primary: "Ver como funciona", secondary: "Desenhar um piloto", tertiary: "Conhecer a plataforma" },
    ...
    cta: { title: "Comece com um produto e um objetivo concreto", body: "Desenhamos um piloto para uma linha, lote ou edição e definimos informação, sinais e próxima ação.", primary: "Desenhar um piloto", secondary: "Falar com vendas" },
  ...
  en: {
    ...
    hero: { badge: "Identity and evidence for physical products", title: "Every product explains what is known and what happens next.", body: "nexID connects a smart label or code with information approved by your organization. People consult it in the browser and see a clear result, its source and the next step.", primary: "See how it works", secondary: "Design a pilot", tertiary: "Explore the platform" },
    ...
    cta: { title: "Start with one product and one concrete objective", body: "We design a pilot for a line, batch or edition and define information, signals and the next action.", primary: "Design a pilot", secondary: "Talk to sales" },
    docsList: ["Discovery workshop and technical scoping", "Tenant onboarding and access governance", "Batch setup and activation playbook", "Operational monitoring and fraud alerts", "Go-live support and success metrics"],
  },
};
