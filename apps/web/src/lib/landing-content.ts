...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      title: "Converti cada producto premium en un canal verificable de confianza, garantia y fidelizacion.",
      body: "El cliente toca NFC o QR, ve si el producto es real, conoce origen y lote, reclama garantia, recibe beneficios y puede guardar su certificado digital.",
