...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    roi: { eyebrow: "ROI", title: "Valor defendible para dirección e inversores", description: "Menos fraude, más datos propios y más relación postventa por cada unidad vendida.", metrics: [{ label: "Riesgo de fraude", value: "-30% a -70%", detail: "Depende de vertical, carrier y adopción secure." }, { label: "Visibilidad comercial", value: "+10x", detail: "Más datos por país, ciudad, canal, lote y evento." }, { label: "Margen y fidelización", value: "+8% a +18%", detail: "Activado por club, garantía, marketplace y certificados." }] },
