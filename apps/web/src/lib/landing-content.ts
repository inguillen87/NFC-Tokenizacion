...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      body: "Con un toque NFC o un escaneo QR, cada cliente conoce el producto, consulta la información de la marca y accede a garantía, beneficios o postventa. nexID verifica la etiqueta digital y muestra el resultado de la lectura. La autenticidad del producto físico requiere controles adicionales.",
  ...
  "pt-BR": {
    ...
    hero: { badge: "Evidência NFC, rastreabilidade declarada e pós-venda", title: "Transforme cada produto premium em um canal verificável de confiança, garantia e fidelização.", body: "Com um toque NFC ou um QR, cada cliente conhece o produto, consulta as informações da marca e acessa garantia, benefícios ou pós-venda. A nexID verifica a etiqueta digital e mostra o resultado da leitura. A autenticidade do produto físico requer controles adicionais.", primary: "Agendar demo", secondary: "Ver Demo Lab", tertiary: "Quero ser revendedor" },
  ...
  en: {
    ...
    hero: { badge: "NFC evidence, declared traceability and digital after-sales", title: "Turn every premium product into a trusted channel for verification, warranty and loyalty.", body: "With one NFC tap or QR scan, each customer learns about the product, reviews the brand's information and accesses warranty, benefits or after-sales. nexID verifies the digital label and shows the reading result. Physical product authenticity requires additional checks.", primary: "Book demo", secondary: "Open Demo Lab", tertiary: "Become a reseller" },
