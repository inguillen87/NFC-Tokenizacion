...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      body: "Con un toque NFC o un escaneo QR, tus clientes acceden a la historia del producto, garantía, beneficios y postventa. Vos definís la experiencia y nexID registra lecturas y acciones, sin exigir una app.",
  ...
  "pt-BR": {
    ...
    hero: { badge: "Produtos conectados · Relações que continuam", title: "Que a relação com seu cliente não termine na venda.", body: "Com um toque NFC ou uma leitura de QR, seus clientes acessam a história do produto, garantia, benefícios e pós-venda. Você define a experiência e a nexID registra leituras e ações, sem exigir um app.", primary: "Ver a experiência", secondary: "Agendar uma demo", tertiary: "Quero ser revendedor" },
  ...
  en: {
    ...
    hero: { badge: "Connected products · Relationships that continue", title: "Do not let the customer relationship end at checkout.", body: "With an NFC tap or QR scan, customers access the product story, warranty, benefits, and after-sales support. You define the experience, and nexID records reads and actions without requiring an app.", primary: "See the experience", secondary: "Book a demo", tertiary: "Become a reseller" },
