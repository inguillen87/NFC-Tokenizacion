...
export const landingContent: Record<AppLocale, LandingContent> = {
  ...
  en: {
    ...
    what: { eyebrow: "Platform value", title: "We do more than tags: we deliver SaaS that helps you sell", description: "One platform for NFC chips, traceability, and token-ready product identity.", cards: [{ title: "SaaS for NFC chips", body: "Manage NTAG215 and NTAG424 in one place." }, { title: "Traceability SaaS", body: "See every scan with business context." }, { title: "Tokenizable SaaS", body: "Turn physical products into digital relationships." }] },
