...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      body: "Con NFC seguro o QR, tus clientes consultan la evidencia disponible, el origen y el lote declarados, y acceden a la próxima acción de postventa. El tap valida el mensaje NFC/SUN y la política configurada; por sí solo no prueba autenticidad física, contenido, origen, sello ni custodia. Conversión y recompra se miden en cada piloto; no se prometen.",
  ...
  "pt-BR": {
    ...
    hero: { badge: "Evidência NFC, rastreabilidade declarada e pós-venda", title: "Transforme cada produto premium em um canal verificável de confiança, garantia e fidelização.", body: "Com NFC seguro ou QR, o cliente consulta evidências e dados de origem e lote declarados. O toque valida a mensagem NFC/SUN e a política configurada; sozinho não comprova autenticidade física, conteúdo, origem, lacre ou custódia. Conversão e recompra são medidas em cada piloto; não são prometidas.", primary: "Agendar demo", secondary: "Ver Demo Lab", tertiary: "Quero ser revendedor" },
  ...
  en: {
    ...
    hero: { badge: "NFC evidence, declared traceability and digital after-sales", title: "Turn every premium product into a trusted channel for verification, warranty and loyalty.", body: "With secure NFC or QR, customers can review evidence plus declared origin and batch. A tap validates the NFC/SUN message and configured policy; by itself it does not prove physical authenticity, contents, origin, seal or custody. Conversion and repeat purchase are measured in each pilot, not promised.", primary: "Book demo", secondary: "Open Demo Lab", tertiary: "Become a reseller" },
