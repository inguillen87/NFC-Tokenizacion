...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    what: {
      ...
      description: "Una sola plataforma para trazabilidad, tokenización y ventas con NFC.",
      cards: [
        ...
        { title: "SaaS tokenizable", body: "Convertís producto físico en identidad digital y beneficios." },
      ],
    },
    plans: {
  ...
  en: {
    ...
    howItWorks: { eyebrow: "How it works", title: "Tap, verify, and sell better", description: "Each tap gives a clear answer: real or not, where, and what to do next.", steps: [{ title: "1. Batch encoding", body: "Configure basic/secure profile, SKU, tenant and activation rules." }, { title: "2. Field tap", body: "Each tap runs duplicate, geo and tamper-adjacent checks." }, { title: "3. Authentication gateway", body: "Stable contracts for SUN validation and admin operations." }, { title: "4. Business intelligence", body: "KPIs and alerts per brand, market and reseller partner." }] },
