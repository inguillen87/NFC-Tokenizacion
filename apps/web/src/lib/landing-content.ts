...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      body: "Con un toque NFC o un escaneo QR, cada cliente puede conocer el producto, consultar la información de la marca y acceder a garantía, beneficios o postventa. nexID verifica la etiqueta digital; por sí sola, la lectura no confirma que el producto físico sea auténtico. Medimos qué funciona en cada piloto.",
  ...
  "pt-BR": {
    ...
    hero: { badge: "Evidência NFC, rastreabilidade declarada e pós-venda", title: "Transforme cada produto premium em um canal verificável de confiança, garantia e fidelização.", body: "Com um toque NFC ou um QR, cada cliente pode conhecer o produto, consultar as informações da marca e acessar garantia, benefícios ou pós-venda. A nexID verifica a etiqueta digital; por si só, a leitura não confirma que o produto físico seja autêntico. Medimos o que funciona em cada piloto.", primary: "Agendar demo", secondary: "Ver Demo Lab", tertiary: "Quero ser revendedor" },
  ...
  en: {
    ...
    hero: { badge: "NFC evidence, declared traceability and digital after-sales", title: "Turn every premium product into a trusted channel for verification, warranty and loyalty.", body: "With one NFC tap or QR scan, customers can learn about the product, view the brand's information and access warranty, benefits or after-sales. nexID checks the digital label; by itself, the reading does not confirm that the physical product is authentic. We measure what works in each pilot.", primary: "Book demo", secondary: "Open Demo Lab", tertiary: "Become a reseller" },
