...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    hero: {
      ...
      body: "Con NFC seguro o QR, según el caso, tus clientes consultan la evidencia disponible, el origen y el lote declarado, y acceden a la próxima acción de postventa. Conversión y recompra se miden en cada piloto; no se prometen.",
  ...
  "pt-BR": {
    ...
    hero: { badge: "Autenticidade, rastreabilidade e pos-venda digital", title: "Transforme cada produto premium em um canal verificavel de confianca, garantia e fidelizacao.", body: "Com NFC seguro ou QR, conforme o caso, o cliente consulta a evidencia disponivel, a origem e o lote declarado, e acessa a proxima acao de pos-venda. Conversao e recompra sao medidas em cada piloto; nao sao prometidas.", primary: "Agendar demo", secondary: "Ver Demo Lab", tertiary: "Quero ser revendedor" },
  ...
  en: {
    ...
    hero: { badge: "Authenticity, traceability and digital after-sales", title: "Turn every premium product into a trusted channel for verification, warranty and loyalty.", body: "With secure NFC or QR, depending on the use case, a customer can review available evidence, declared origin and batch, then open the next after-sales action. Conversion and repeat purchase are measured in each pilot, not promised.", primary: "Book demo", secondary: "Open Demo Lab", tertiary: "Become a reseller" },
