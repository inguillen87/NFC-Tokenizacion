...
export const landingContent: Record<AppLocale, LandingContent> = {
  "es-AR": {
    ...
    docsList: ["Health check: /health/", "SUN validation: /sun/", "Create tenant: /admin/tenants/", "Batch lifecycle: /admin/batches/", "Manifest import: /admin/batches/:bid/import-manifest/"],
  },
  "pt-BR": {
