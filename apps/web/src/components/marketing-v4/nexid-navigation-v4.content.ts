...
const esAR = {
  ...
  categories: {
    product: {
      ...
      summary: "Identidad, verificación y propiedad digital en una sola plataforma.",
      ...
      links: [
        ...
        { label: "Verificar evidencia", href: "/proof/verify", description: "Consultar una prueba sin entrar al dashboard." },
    ...
    solutions: {
      ...
      links: [
        ...
        { label: "Operaciones offline", href: "/offline", description: "Continuidad de campo con sincronización controlada." },
        { label: "Partners y resellers", href: "/resellers", description: "Implementación y comercialización con nexID." },
      ],
    },
    demo: {
      label: "Demo",
      href: sharedHrefs.demo,
      summary: "Probá el recorrido de producto, evidencia y experiencia post-tap.",
      overviewLabel: "Abrir Demo Lab",
      links: [
        { label: "Demo Lab", href: "/demo-lab", description: "Escenarios guiados por industria y objetivo." },
        { label: "Demo comercial", href: "/demo", description: "Una introducción breve para evaluar el producto." },
        { label: "Sandbox técnico", href: "/demo-sandbox", description: "Pruebas controladas para equipos técnicos." },
      ],
    },
    resources: {
      label: "Recursos",
    ...
    developers: {
      ...
      summary: "SDK, arquitectura y recursos para integrar nexID.",
      overviewLabel: "Explorar SDK",
      links: [
        { label: "SDK", href: "/sdk", description: "Puntos de entrada para comenzar una integración." },
        { label: "Documentación técnica", href: "/docs", description: "Contratos, flujos y ejemplos de uso." },
        { label: "Stack", href: "/stack", description: "Arquitectura y tecnologías de la plataforma." },
      ],
    },
  },
  actions: {
    demo: { label: "Ver demo", href: sharedHrefs.demoCta },
  ...
  categories: {
    product: {
      ...
      links: [
        ...
        { label: "Verificar evidência", href: "/proof/verify", description: "Consulte uma prova sem entrar no dashboard." },
    ...
    solutions: {
      ...
      links: [
        ...
        { label: "Operações offline", href: "/offline", description: "Continuidade em campo com sincronização controlada." },
    ...
    demo: {
      ...
      overviewLabel: "Abrir Demo Lab",
      links: [
        { label: "Demo Lab", href: "/demo-lab", description: "Cenários guiados por indústria e objetivo." },
        { label: "Demo comercial", href: "/demo", description: "Uma introdução curta para avaliar o produto." },
        { label: "Sandbox técnico", href: "/demo-sandbox", description: "Testes controlados para equipes técnicas." },
      ],
    },
    resources: {
      label: "Recursos",
    ...
    developers: {
      label: "Developers",
      href: sharedHrefs.developers,
      summary: "SDK, arquitetura e recursos para integrar a nexID.",
      overviewLabel: "Explorar SDK",
      links: [
        { label: "SDK", href: "/sdk", description: "Pontos de entrada para iniciar uma integração." },
        { label: "Documentação técnica", href: "/docs", description: "Contratos, fluxos e exemplos de uso." },
        { label: "Stack", href: "/stack", description: "Arquitetura e tecnologias da plataforma." },
      ],
    },
  },
  actions: {
