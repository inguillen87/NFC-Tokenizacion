...
const VISUAL_COPY: Record<"es-AR" | "en" | "pt-BR", VisualCopy> = {
  "es-AR": {
    ...
    validReading: "LECTURA DIGITAL",
    controls: "MENSAJE LEÍDO",
  ...
  en: {
    ...
    validReading: "DIGITAL READ",
    controls: "MESSAGE READ",
    physicalLimit: "DIGITAL TAG RESULT",
  ...
  "pt-BR": {
    ...
    digitalResult: "RESULTADO DIGITAL",
    validReading: "LEITURA DIGITAL",
    controls: "MENSAGEM LIDA",
