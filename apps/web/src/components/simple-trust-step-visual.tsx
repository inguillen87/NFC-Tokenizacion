...
const VISUAL_COPY: Record<"es-AR" | "en" | "pt-BR", VisualCopy> = {
  "es-AR": {
    sample: "ACERCÁ O ESCANEÁ",
    product: "Reserva Andina",
    productType: "Malbec 2024",
    lot: "LOTE  RA-2407",
    origin: "ORIGEN DECLARADO  MENDOZA, AR",
    digitalResult: "RESPUESTA CLARA",
    validReading: "LISTO PARA SEGUIR",
    controls: "LECTURA COMPLETA",
    physicalLimit: "INFORMACIÓN DE LA ETIQUETA",
    programOptions: "ELEGÍ CÓMO SEGUIR",
    warranty: "GARANTÍA",
    available: "ACTIVAR",
    benefit: "BENEFICIOS",
    brandExperience: "VER OPCIONES",
    support: "AYUDA",
    channelEnabled: "CONTACTAR A LA MARCA",
  },
  en: {
    sample: "TAP OR SCAN",
    ...
    digitalResult: "CLEAR ANSWER",
    validReading: "ALL SET",
    controls: "READ COMPLETE",
    physicalLimit: "DIGITAL TAG INFORMATION",
    programOptions: "CHOOSE WHAT COMES NEXT",
    warranty: "WARRANTY",
    available: "ACTIVATE",
    benefit: "BENEFITS",
    brandExperience: "VIEW OPTIONS",
    support: "HELP",
    channelEnabled: "CONTACT THE BRAND",
  },
  "pt-BR": {
    sample: "APROXIME OU ESCANEIE",
    product: "Reserva Andina",
    productType: "Malbec 2024",
    lot: "LOTE  RA-2407",
    origin: "ORIGEM DECLARADA  MENDOZA, AR",
    digitalResult: "RESPOSTA CLARA",
    validReading: "TUDO CERTO",
    controls: "LEITURA COMPLETA",
    physicalLimit: "INFORMAÇÃO DA ETIQUETA",
    programOptions: "ESCOLHA O PRÓXIMO PASSO",
    warranty: "GARANTIA",
    available: "ATIVAR",
    benefit: "BENEFÍCIOS",
    brandExperience: "VER OPÇÕES",
    support: "AJUDA",
    channelEnabled: "FALAR COM A MARCA",
  },
};
