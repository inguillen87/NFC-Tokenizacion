  ...
  "pt-BR": {
    ...
    items: {
      ...
      electronics: {
        ...
        objectClass: "electronics-demo scanning",
        phoneTag: "ELECTRONICS - WARRANTY_OK",
        steps: ["Toque na caixa/equipamento", "SUN valida serie", "Garantia ativa", "Habilita suporte"],
      },
      textile: {
        label: "Textil",
        profile: "NFC + QR DPP",
        ...
        objectClass: "textile-demo scanning",
        phoneTag: "TEXTILE - DPP_OK",
        steps: ["Leitura da etiqueta", "Valida passaporte DPP", "Mostra materiais/origem", "Habilita revenda/cuidados"],
      },
    },
  },
  en: {
...
const heroRealAssets: Record<Vertical, {
  ...
  wine: {
    imageUrl: "/sdk/verticals/wine-spirits-424-tt.webp",
