...
const carrierProfiles: Record<AppLocale, CarrierProfile[]> = {
  "es-AR": [
    ...
    },
    {
      ...
      unlocks: "Tamper fisico, ciclo de vida, garantia, marketplace, propiedad y token Polygon/Amoy.",
      policy: "La propiedad se habilita solo con tap fresco + prueba/politica de compra; replay o vista guardada bloquean acciones.",
  ...
  "pt-BR": [
    ...
    },
    {
      ...
      unlocks: "Tamper fisico, ciclo de vida, garantia, marketplace, propriedade e token Polygon/Amoy.",
      policy: "Propriedade so abre com toque fresco + prova/politica de compra; replay ou vista salva bloqueiam acoes.",
      suggestedFor: ["enterprise"],
    },
  ],
  en: [
