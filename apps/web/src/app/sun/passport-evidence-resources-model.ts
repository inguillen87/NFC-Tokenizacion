...
export const passportEvidenceCopy = {
  "es-AR": {
    ...
    declared: "Perfil y documentos: información declarada por la marca.",
  ...
  en: {
    ...
    declared: "Profile and documents: information declared by the brand.",
  ...
  "pt-BR": {
    ...
    declared: "Perfil e documentos: informações declaradas pela marca.",
