...
export const SUN_UI_TRANSLATIONS: readonly SunTranslation[] = [
  ...
  { es: "JSON simulado del Demo Lab", pt: "JSON simulado do Demo Lab", en: "Simulated Demo Lab JSON" },
  { es: "Usá Ctrl + desplazamiento para acercar el mapa", pt: "Use Ctrl + rolagem para ampliar o mapa", en: "Use Ctrl + scroll to zoom the map" },
  { es: "Demo · conexión ilustrativa", pt: "Demo · conexão ilustrativa", en: "Demo · illustrative connection" },
