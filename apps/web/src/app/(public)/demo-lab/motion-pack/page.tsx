...
const copyByLocale: Record<AppLocale, MotionCopy> = {
  "es-AR": {
    ...
    productLabels: { wine: "Vino", seeds: "Semillas", cream: "Crema", perfume: "Packaging", bracelet: "Pulsera", ticket: "Entrada" },
    productCards: {
      ...
      perfume: { title: "Estuche Aurora", body: "El packaging conectado reúne materiales, lote e información de circularidad en un pasaporte actualizable, sin certificar por sí solo su estado físico.", seal: "NFC en estuche" },
  ...
  "pt-BR": {
    ...
    productLabels: { wine: "Vinho", seeds: "Sementes", cream: "Creme", perfume: "Packaging", bracelet: "Pulseira", ticket: "Ingresso" },
    productCards: {
      ...
      perfume: { title: "Estuche Aurora", body: "A embalagem conectada reúne materiais, lote e informação de circularidade em um passaporte atualizável, sem certificar sozinha seu estado físico.", seal: "NFC na embalagem" },
  ...
  en: {
    ...
    productLabels: { wine: "Wine", seeds: "Seeds", cream: "Cream", perfume: "Packaging", bracelet: "Bracelet", ticket: "Ticket" },
    productCards: {
      ...
      perfume: { title: "Estuche Aurora", body: "Connected packaging brings materials, batch and circularity information into an updatable passport without certifying physical condition by itself.", seal: "NFC package" },
