...
const copyByLocale: Record<"es-AR" | "pt-BR" | "en", DemoCopy> = {
  "es-AR": {
    ...
    jumpCards: [
      { title: "Trust state", body: "Cómo se presenta un resultado de mensaje válido, alertado o bloqueado sin juzgar el objeto físico.", icon: "trust" },
      { title: "Experiencia mobile", body: "Qué ve una persona cuando toca una etiqueta o abre una credencial demo.", icon: "mobile" },
      { title: "Vista operativa", body: "Cómo se conectan mapa, feed, batches y superficies demo para ventas e inversores.", icon: "ops" },
    ],
    ...
    howSteps: [
      ...
      "3. Mirá las superficies demo, con fuente identificada, para entender status, geografía y UX de confianza.",
    ],
    proofTitle: "Qué debería quedarte claro al terminar",
    proofBullets: [
      "nexID no es solo hardware: es infraestructura operativa y comercial.",
      "La experiencia final puede ser simple aunque el backend aplique controles y políticas por tenant.",
      "Verify, Passport y Rights se entienden mejor cuando se ven juntos en una demo guiada.",
    ],
  ...
  "pt-BR": {
    ...
    jumpCards: [
      { title: "Trust state", body: "Como apresentar um resultado de mensagem válido, alertado ou bloqueado sem julgar o objeto físico.", icon: "trust" },
      { title: "Experiência mobile", body: "O que a pessoa vê quando toca uma etiqueta ou abre uma credencial demo.", icon: "mobile" },
      { title: "Visão operacional", body: "Como mapa, feed, batches e superfícies demo se conectam para vendas e investidores.", icon: "ops" },
    ],
    ...
    howSteps: [
      ...
      "3. Veja as superfícies demo com origem identificada para entender status, geografia e UX de confiança.",
    ],
    proofTitle: "O que deve ficar claro ao final",
    proofBullets: [
      "nexID não é só hardware: é infraestrutura operacional e comercial.",
      "A experiência final pode ser simples enquanto o backend aplica controles e políticas por tenant.",
      "Verify, Passport e Rights ficam mais claros quando aparecem juntos em uma demo guiada.",
    ],
  ...
  en: {
    ...
    jumpCards: [
      ...
      { title: "Operations view", body: "How map, feed, batches and demo surfaces connect for sales and investors.", icon: "ops" },
    ],
    ...
    howSteps: [
      ...
      "3. Review source-labelled demo surfaces to understand status, geography and trust UX.",
    ],
    proofTitle: "What should be clear by the end",
    proofBullets: [
      "nexID is not just hardware: it is operational and commercial infrastructure.",
      "The end-user experience can stay simple while the backend applies tenant policies and controls.",
      "Verify, Passport and Rights make more sense when seen together in a guided demo flow.",
    ],
  ...
  return (
    <main className="py-10">
      <section className="container-shell space-y-6">
        ...
        <DemoSessionPlanner locale={locale} />
        <DemoReadinessBoard locale={locale} />
