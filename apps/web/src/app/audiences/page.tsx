...
const copyByLocale: Record<"es-AR" | "pt-BR" | "en", AudienceCopy> = {
  "es-AR": {
    ...
    cards: [
      {
        ...
        sell: ["Señales de riesgo y control de canal.", "Passport por unidad para postventa y CRM.", "Ownership digital, garantía y activaciones bajo política."],
      ...
      },
      {
        ...
        icon: "government",
        hook: "Entrá por auditabilidad, eventos de custodia reportados y evidencia digital.",
        sell: ["Mensajes y documentos digitales verificables.", "Control de contratistas, accesos y presencia declarada por evento.", "Registro auditable y arquitectura DPP-ready."],
      ...
      },
      {
        ...
        sell: ["Resultado simple del mensaje: válido, alertado o bloqueado.", "Beneficios sujetos a identidad, compra y política.", "Tap simple con límites de evidencia visibles."],
    ...
    investorBullets: [
      "Fase 1: Verify (mensaje NFC/SUN + anti-replay + TT reportado) como wedge comercial.",
      "Fase 2: Passport (lote, origen y eventos declarados + cumplimiento).",
      "Fase 3: Rights (ownership digital, garantías, vouchers y transferencias bajo política).",
      "Fase 4: Registry/Market como expansión selectiva.",
    ],
    investorNote: "Clave: no vender la visión más larga antes de medir Verify + Passport en un piloto y confirmar su caso económico.",
    ...
    intentCards: [
      ...
      { title: "Explorar demo", body: "Pedir una demo guiada del flujo y de los límites de la validación digital.", href: "/?contact=demo&intent=demo_lab&vertical=events#contact-modal", kind: "lead" },
  ...
  "pt-BR": {
    ...
    jumpTitle: "Explorar por tipo de comprador",
    cards: [
      { audience: "Empresas / marcas", icon: "brands", hook: "Comece por receita mensurável, pós-venda e controle de canal.", sell: ["Sinais de risco e controle de canal.", "Passport por unidade para pós-venda.", "Ownership digital, garantia e ativações por política."], avoid: "Evitar começar com jargão cripto.", cta: "Abrir docs de produto" },
      ...
      { audience: "Governo", icon: "government", hook: "Comece por auditabilidade, eventos de custódia reportados e evidência digital.", sell: ["Mensagens e documentos digitais verificáveis.", "Acesso e presença declarada por evento.", "Registro auditável DPP-ready."], avoid: "Evitar narrativa 'cripto first'.", cta: "Ver stack verificável" },
      { audience: "Cliente final", icon: "customer", hook: "Comece por experiência simples: tocar, ler o resultado e solicitar benefício.", sell: ["Resultado simples da mensagem.", "Benefícios sujeitos a identidade, compra e política.", "Tap simples com limites de evidência visíveis."], avoid: "Evitar UX longa e confusa.", cta: "Abrir demo" },
    ],
    investorTitle: "Narrativa para investidores",
    investorBullets: ["Fase 1: Verify (mensagem NFC/SUN, anti-replay e TT reportado).", "Fase 2: Passport (dados e eventos declarados).", "Fase 3: Rights (direitos digitais por política).", "Fase 4: Registry/Market seletivo."],
    investorNote: "Ponto-chave: não vender a visão longa antes de medir Verify + Passport em um piloto e confirmar o caso econômico.",
    ...
    intentCards: [
      ...
      { title: "Explorar demo", body: "Pedir uma demo guiada do fluxo e dos limites da validação digital.", href: "/?contact=demo&intent=demo_lab&vertical=events#contact-modal", kind: "lead" },
  ...
  en: {
    ...
    cards: [
      { audience: "Brands / enterprises", icon: "brands", hook: "Lead with measurable revenue, after-sales and channel control.", sell: ["Risk signals and channel controls.", "Unit passport for after-sales and CRM.", "Digital ownership, warranty and activation under policy."], avoid: "Avoid opening with crypto-financial language.", cta: "Open product docs" },
      ...
      { audience: "Government", icon: "government", hook: "Lead with auditability, reported custody events and digital evidence.", sell: ["Verifiable digital messages and documents.", "Contractor, access and event-declared presence controls.", "Auditable registry and DPP-ready architecture."], avoid: "Avoid crypto-first positioning.", cta: "View verifiable stack" },
      { audience: "End customer", icon: "customer", hook: "Lead with simple UX: tap, read the result, request value.", sell: ["Simple tag-message status.", "Benefits subject to identity, purchase and policy.", "Low-friction tap with visible evidence limits."], avoid: "Avoid complex multi-step UX.", cta: "Open demo" },
    ],
    investorTitle: "Investor narrative (recommended order)",
    investorBullets: ["Phase 1: Verify (NFC/SUN message, replay controls and reported TT).", "Phase 2: Passport (declared data and events).", "Phase 3: Rights (policy-governed digital rights).", "Phase 4: Selective Registry/Market expansion."],
    investorNote: "Key point: do not sell the long vision before measuring Verify + Passport in a pilot and confirming the economic case.",
    ...
    intentCards: [
      ...
      { title: "Explore the demo", body: "Request a guided demo of the flow and the boundaries of digital validation.", href: "/?contact=demo&intent=demo_lab&vertical=events#contact-modal", kind: "lead" },
