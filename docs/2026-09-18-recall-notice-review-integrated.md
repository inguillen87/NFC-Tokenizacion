...
## Cierre de aceptación antes de producción

Se repitieron los controles finales: API y web compilaron; TypeScript, tests y
build del dashboard aprobados. Dashboard: 870 pruebas, 868 aprobadas, cero fallidas
y dos omitidas. Web: 571 aprobadas. API: 46 pruebas de política y cuatro de contrato,
más 20 escenarios con handlers reales y PostgreSQL 17.10 desechable. Los 19
escenarios previos de retiros también habían pasado con el esquema aditivo.

Se actualizó la aserción de compatibilidad del test de release para exigir
api-notices.1 y web-notices.1, conservando los demás controles. Los tres gates de
secretos pasaron. El recorrido integrado de navegador y cuatro variantes visuales
tienen reporte aprobado sobre las mismas fuentes funcionales. Ninguna de esas
pruebas creó retiros en producción.
