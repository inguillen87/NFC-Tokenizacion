...
const files = [
  'supplier-requests', 'supplier-request-reviews', 'supplier-request-assignments', 'supplier-request-cancellation', 'supplier-binding-policy', 'supplier-request-binding', 'supplier-quote-policy', 'supplier-request-quotes',
