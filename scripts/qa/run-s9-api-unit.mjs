...
const files = [
  'support-report', 'support-report-routes', 'admin-ticket-lookup', 'public-cta-request-truth', 'sun-fresh-handoff', 'admin-tickets-rbac-contract', 'admin-resource-tenant-isolation',
